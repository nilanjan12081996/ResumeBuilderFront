...
const ImpResumeScore = ({ score = 0, loading = false, guide = "", onCompareClick, isComparingLoading, onPreviewClick }) => {
        ...
        <div className="bg-white rounded-lg p-5 mb-2 mx-auto">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex flex-col gap-3">
                    {/* guide prop থাকলে How to improve দেখাবে — আগের condition same */}
                    {guide && <HowToImprove />}
