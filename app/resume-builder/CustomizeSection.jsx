        ...
        {['Template & Colors', 'Text', 'Layout'].map((tab) => (
          <button
            ...
            className={`px-12 py-4 text-lg font-medium transition-all border-b-4 ${
              activeTab === tab ? 'border-blue-500 text-slate-900' : 'border-transparent text-slate-400'
            }`}
          >
            {tab}
          </button>
          ...
          {filters.map((f) => (
            <button
              ...
              className={`px-6 py-2 rounded-full border text-sm font-medium transition-all ${
                filter === f ? 'bg-blue-500 border-blue-500 text-white' : 'bg-white border-gray-300 hover:border-blue-500'
              }`}
            >
              {f}
            </button>
