    ...
    <div className='flex gap-5 pb-5'>
        ...
        <div className='w-6/12 bg-[#ffffff] border border-[#E5E5E5] rounded-[8px] p-5'>
          <div className='flex items-center justify-between mb-4'>
            ...
            <div className='flex items-center gap-3'>
              ...
              <button className='bg-[#800080] hover:bg-[#F6EFFF] rounded-[7px] text-[12px] leading-[36px] text-[#ffffff] hover:text-[#92278F] font-medium cursor-pointer px-4 flex items-center gap-1.5'><IoMdDownload className='text-[18px]' /> Download DOCX</button>
        ...
        <Modal size="3xl" className="apply_modal_area" show={openModalAnalyzeResume} onClose={() => setOpenModalAnalyzeResume(false)}>
              ...
              <ModalBody className='bg-white p-5 rounded-b-[4px] relative'>
                  ...
                  <div className='bg-[#FFFFFF] rounded-[10px] shadow-2xl absolute left-[10px] bottom-[-150px] p-5'>
