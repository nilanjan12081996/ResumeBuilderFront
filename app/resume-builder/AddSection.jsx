...
import { FaChessKnight, FaLanguage, FaCertificate, FaList } from "react-icons/fa6";
import { FaCheck } from "react-icons/fa";
import { HiSpeakerphone, HiAcademicCap } from "react-icons/hi";

const AddSection = ({ onSelectSection, activeSections = [] }) => {
  ...
  const handleSelectSection = (sectionId, isAlreadyAdded) => {
    ...
    if (selected && !selected.isLocked) {
      onSelectSection && onSelectSection(sectionId);
    }
  };
