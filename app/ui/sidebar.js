...
import { useDispatch, useSelector } from 'react-redux';
import { logout } from '../reducers/AuthSlice';
import { reset } from '../reducers/SearchHistroySlice';
          ...
          <nav className="mt-5 py-4 px-4">
            <ul className="flex flex-col gap-1.5">
              ...
              <li onClick={closeSidebar}>
                <Link
                  href="/dashboard"
                  className={`flex items-center gap-2 px-4 py-3 rounded-sm font-normal text-base
                    ${pathname === '/dashboard'
                ...
                <Link
                  ...
                  className={`flex items-center gap-2 px-4 py-3 rounded-sm font-normal text-base
                    ${pathname.includes('resume-history')
                      ...
                      : 'text-gray-500 hover:bg-gray-200 hover:text-[#800080]'}`}
                >
                  <HiDocumentText className="text-2xl" /> Resume History
                </Link>
              </li>
                ...
                <Link
                  ...
                  className={`flex items-center gap-2 px-4 py-3 rounded-sm font-normal text-base
                    ${pathname.includes('resume-templates')
                      ...
                      : 'text-gray-500 hover:bg-gray-200 hover:text-[#800080]'}`}
                >
                  <BiSolidDashboard className="text-2xl" /> Create Resume
                </Link>
              </li>
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-2 px-4 py-3 rounded-sm font-normal text-base
                      ${pathname.includes('featured-jobs')
                        ...
                        : 'text-gray-500 hover:bg-gray-200 hover:text-[#800080]'}`}
                  >
                    <BiSolidBriefcase className="text-2xl" /> Featured Jobs
                  </Link>
                </li>
              )}

              {/* Invite Students (conditional) */}
              {profileData?.data?.signUpType?.[0]?.UserSignUpTypeMap?.sign_up_type_id !== 1 && (
                <li onClick={closeSidebar}>
                  <Link
                    href="/invite-students"
                    className={`flex items-center gap-2 px-4 py-3 rounded-sm font-normal text-base
                      ${pathname.includes('invite-students')
                        ...
                        : 'text-gray-500 hover:bg-gray-200 hover:text-[#800080]'}`}
                  >
                    <HiUserAdd className="text-2xl" /> Invite Students
                  </Link>
                </li>
              )}
              ...
              <li onClick={closeSidebar}>
                <button
                  onClick={handleLogout}
                  className="flex items-center gap-2 px-4 py-3 rounded-sm font-normal text-base text-gray-500 hover:bg-gray-200 hover:text-[#800080] w-full text-left cursor-pointer"
                >
