...
const LinkdinAtsScoreAnalyzeModal = ({ show, setShow, atsData }) => {
  ...
  return (
    <Modal size="lg" show={show} onClose={() => setShow(false)}>
      <ModalHeader className="flex justify-between items-center bg-white border-b border-gray-200 px-5 py-3">
        <span className="text-[18px] font-semibold text-[#800080]">LinkedIn Rewrite Score Analyze</span>
      </ModalHeader>
...
export default LinkdinAtsScoreAnalyzeModal;
