                    ...
                    <AccordionPanel>
                      ...
                      <AccordionContent className="pt-0">
                        ...
                        <ImpDynamicFields
                                ...
                                <div className="flex items-center gap-3">
                                  ...
                                  <div className="relative group">
                                    <button
                                      ...
                                      onClick={(e) => {
                                        e.stopPropagation();
                                        if (!isExhausted) setActiveExpId(exp.id);
                                      }}
                          ...
                          onChange={(newFields) => handleExpUpdate(sectionIndex, exp.id, "customFields", newFields)}
                          onCoreFieldChange={(id, value) => handleExpUpdate(sectionIndex, exp.id, "description", value)}
                          onOrderChange={(newOrder) => handleExpUpdate(sectionIndex, exp.id, "fieldOrder", newOrder)}
                          fieldOrder={exp.fieldOrder || []}
                          suggestions={["Key Achievements", "Technologies", "Department", "Live URL", "Repository"]}
                        />
