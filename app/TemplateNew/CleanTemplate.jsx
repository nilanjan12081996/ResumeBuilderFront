    ...
    <div className="min-h-[297mm] bg-white text-gray-900 font-sans p-10 shadow-xl">
      ...
      <div className="flex gap-10">
        ...
        <div className="w-[30%] flex flex-col gap-10 border-r border-gray-200 pr-6">
          ...
          {hasContactInfo && (
            <section>
              <h3 className="text-xs font-bold uppercase tracking-[0.15em] mb-4 text-black">Details</h3>
              <div className="flex flex-col gap-3 text-xs text-gray-600">
                ...
                {formData.email && (
                  <div className="flex flex-col">
                    ...
                    <a href={`mailto:${formData.email}`} className="break-all hover:text-black hover:underline">
                      {formData.email}
                    </a>
                  </div>
                )}
          ...
          {/* LINKS (Placeholder if you add links to formData later) */}
          {(formData.linkedin || formData.website) && (
             <section>
              <h3 className="text-xs font-bold uppercase tracking-[0.15em] mb-4 text-black">Links</h3>
          ...
          {hasLanguages && (
            <section>
              <h3 className="text-xs font-bold uppercase tracking-[0.15em] mb-4 text-black">Languages</h3>
          ...
          {/* HOBBIES (If short, fit nicely in sidebar, otherwise move to right) */}
          {/* {formData.hobbies && (
            <section>
              <h3 className="text-xs font-bold uppercase tracking-[0.15em] mb-4 text-black">Hobbies</h3>
        ...
        <div className="w-[70%] flex flex-col gap-8">
          ...
          {formData.summary && (
            <section>
              <h2 className="text-sm font-bold uppercase tracking-[0.15em] text-black mb-3">Profile</h2>
          ...
          {hasEducation && (
            <section>
              <h2 className="text-sm font-bold uppercase tracking-[0.15em] text-black mb-4">Education</h2>
          ...
          {hasEmployment && (
            <section>
              <h2 className="text-sm font-bold uppercase tracking-[0.15em] text-black mb-4">Employment History</h2>
          ...
          {/* INTERNSHIPS (Reusing Employment Style) */}
          {hasInternships && (
             <section>
             <h2 className="text-sm font-bold uppercase tracking-[0.15em] text-black mb-4">Internships</h2>
             <div className="flex flex-col gap-5">
          ...
          {hasActivities && (
            <section>
              <h2 className="text-sm font-bold uppercase tracking-[0.15em] text-black mb-4">Activities</h2>
                ...
                {formData.activityHistory.map((act, idx) => (
                  <div key={idx} className="flex justify-between items-start group">
                    <div className="w-[80%]">
                      ...
                      {act.description && (
                        <p className="text-[11px] text-gray-500 mt-1">{act.description}</p>
                      )}
                    </div>
                    <div className="text-right">
                       <span className="text-[10px] text-gray-500 block">{act.city}</span>
           ...
           {hasCourses && (
            <section>
              <h2 className="text-sm font-bold uppercase tracking-[0.15em] text-black mb-4">Courses</h2>
              <div className="flex flex-col gap-4">
          ...
          {hasSkills && (
            <section>
              <h2 className="text-sm font-bold uppercase tracking-[0.15em] text-black mb-4">Skills</h2>
              <div className="grid grid-cols-1 gap-y-2">
                {formData.newSkillHistory.map((skill, idx) => (
                  <div key={idx} className="flex items-center justify-between border-b border-gray-100 pb-1 last:border-0">
                    <span className="text-xs font-semibold text-gray-700">{skill.skill}</span>
                    {/* If you want to show level as text or a small bar, you can add it here. 
                        The sample image just showed years or levels. I'll stick to simple text. */}
