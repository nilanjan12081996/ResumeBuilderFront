      ...
      <section key="employment">
        ...
        {formData.employmentHistory.map((job, i) => (
          <div key={i} style={{ marginBottom: "7pt" }}>
            ...
            />
            {renderDynamicFields(job, { ...bodyStyle, color: "#374151", marginTop: "2pt" })}
          </div>
        ))}
      </section>
    );
      ...
      <section key="activities">
        ...
        {formData.activityHistory.map((act, i) => (
          <div key={i} style={{ marginBottom: "6pt" }}>
            ...
            />
            {renderDynamicFields(act, { ...bodyStyle, color: "#374151", marginTop: "2pt" })}
          </div>
        ))}
      </section>
    );
    ...
    <section key={section.id}>
      ...
      {section.experiences?.map((exp, i) => (
        <div key={exp.id || i} style={{ marginBottom: "7pt" }}>
          ...
          />
          {renderDynamicFields(exp, { ...bodyStyle, color: "#374151", marginTop: "2pt" })}
        </div>
      ))}
    </section>
  );
    ...
    <section key={section.id}>
      ...
      {section.certifications?.map((cert, i) => (
        <div key={cert.id || i} style={{ marginBottom: "5pt" }}>
          ...
          />
          {renderDynamicFields(cert, { ...bodyStyle, color: "#374151", marginTop: "2pt" })}
        </div>
      ))}
    </section>
  );
    ...
    <section key={section.id}>
      ...
      {section.internships?.map((intern, i) => (
        <div key={intern.id || i} style={{ marginBottom: "6pt" }}>
          ...
          />
          {renderDynamicFields(intern, { ...bodyStyle, color: "#374151", marginTop: "2pt" })}
        </div>
      ))}
    </section>
  );
    ...
    <section key={section.id}>
      ...
      {section.activities?.map((a, i) => (
        <div key={a.id || i} style={{ marginBottom: "6pt" }}>
          ...
          />
          {renderDynamicFields(a, { ...bodyStyle, color: "#374151", marginTop: "2pt" })}
        </div>
      ))}
    </section>
  );
                ...
                <tbody>
                  <tr>
                    {(formData.address || formData.city_state || formData.country) && (
                      <td style={{ ...bodyStyle, color: "#333", paddingRight: "10pt", whiteSpace: "normal" }}>
